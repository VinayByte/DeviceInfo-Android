...
import com.egnize.deviceinfo.adapters.SensorListAdapter
import com.egnize.deviceinfo.models.SensorDATA
...
//        now adding the adapter to RecyclerView
    ...
    private fun snackBarCustom(view: View, message: String) {
        ...
        val mainTextView = mSnackBar.view.findViewById<View>(R.id.snackbar_text) as TextView
